...
/**
 * Ҳадди аксари холи як кластер: 10 саволи ММТ × 4 холи имконпазир.
 *
 * Пештар ин ҷо 30 навишта шуда буд, ва backend бошад 40 ҳисоб мекард —
 * барои холи пурра сутуни панел 133% нишон медод ва аз чорчӯба мебаромад.
 */
